      ...
      <form method="POST" action="database/authentifier.php">
        <div class="row">
          ...
          <div class="col bg-light">
            ...
            <hr>
            <div class="mb-3 py-5">
              <input type="text" class="form-control" id="1" placeholder="Login" name="login" required>
            </div>
            <div class="mb-3">
              <input type="password" class="form-control" id="2" placeholder="Mot de phrase" name="password" required>
            </div>
            <div class="mb-3 py-5">
