...
$table = $db->query('select* FROM supptable order by idcontent desc');
?>
<!doctype html>
<html lang="en">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered text-dark">
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    <div class="container">
                                                        <p align="center"><strong>Etes-vous sûr de vouloir supprimer cette carte définitivement?</strong></p>
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="close" class="btn btn-danger" data-bs-dismiss="modal">Non</button>
                                                    <a type="button" class="btn btn-warning" href="database/suppdef.php?idcontent=<?php echo $post['idcontent']; ?>">
                                                        Oui
                                                    </a>
                                                </div>
                                            </div>
