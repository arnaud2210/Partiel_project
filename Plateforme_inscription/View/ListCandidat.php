...
<h2 align="center">LISTE DES CANDIDATURES</h2>
        <div class="container">
          ...
          <div class="form-check form-check-inline">
                <a href="assets/fpdf/print.php" class="btn btn-secondary btn-sm">
              ...
              <!--form action="ListCandidat.php" method="post">
                <btn name="sexe" class="btn btn-secondary btn-sm">
                  sexe
                </btn>
                <btn name="asc" type="submit" class="btn btn-secondary btn-sm">
                  série
                </btn>
              </form-->
            </div>
                      ...
                      ?>  <tr>
                            ...
                            <td align="center">
                              <a class="btn btn-danger btn-sm" href="database/telecharger.php?num=<?php echo $post['numfic'];?>">
                                ...
                                att-<?php echo htmlspecialchars($post['numfic']); ?>
                              </a>
